...
// Оголоси функцію getShippingCost(country),
            //   Узнать стоимость доставки (страна),
...
//  де замість <country> і <price> ("Доставка в <страна> будет стоить <цена> кредитов",
// де замість <страна> і <цена>)необхідно підставити відповідні значення.
